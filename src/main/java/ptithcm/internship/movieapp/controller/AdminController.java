...
public class AdminController {
	...
	public String editWeb(@PathVariable("webId") String webId,
			@PathVariable("newWebName") String newWebName, @PathVariable("newWebTitle") String newWebTitle) {
	...
	@RequestMapping("/filmManagerAdvance")
	...
	@PostMapping("editFilm/{fid}")
	@ResponseBody
	public ResponseEntity<?> editFilmRest(@RequestBody FilmRequest filmRequest, @PathVariable("fid") String fid) {
		LOGGER.info("editFilmRest: " + " filmRequest=" + filmRequest);
	...
	public String deleteFilm(@PathVariable("fid") String fid) {
		...
		return "redirect:/admin/filmManagerAdvance";
	}
	
	@RequestMapping("filmDetail/{fid}")
	public String filmDetail(Model model, @PathVariable("fid") String fid, @RequestParam("searchCondition") String searchCondition) {
		LOGGER.info("filmDetail: " + " fid=" + fid);
		...
		return "film_detail_manager";
	}
	
	@PostMapping("editFilmDetail/{fdid}")
	@ResponseBody
	public ResponseEntity<?> editFilmDetailRest(@RequestBody FilmDetailRequest filmDetailRequest, @PathVariable("fdid") String fdid) {
		LOGGER.info("editFilmDetailRest: " + " filmDetailRequest=" + filmDetailRequest);
	...
	@RequestMapping("deleteFilmDetail/{fdid}")
	public String deleteFilmDetail(@PathVariable("fdid") String fdid) {
		...
		return "redirect:/admin/filmDetail/" + id + "?searchCondition=";
	}
}
